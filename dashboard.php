		...
		<!--	<section class="sample-text-area">
			...
			<div class="whole-wrap">
				<div class="container">
					...
					<?php echo "<div class='wnameh'><wname><i class='fa fa-graduation-cap'></i>Welcome</wname> $_SESSION[LName]<div class='profile-btn'><a href='profile'><button class='genric-btn primary-border medium'>Profile</button></a></div></div>"; ?></br>					
					<center><?php echo "$_GET[m]"; ?></center>
						<center><h4 class="mb-30">Dashboard</h4></center>
...
<!--						<div class='sidenav'>
						...
						<a href=''>Courses</a>
						  ...
						  <div class="column">
    <a href="inprogress-courses"><h5><i class='fa fa-book'></i> Enrolled courses</h5>
    <p><?php echo $totalc; ?></p></a>
  </div>
  <div class="column">
    <a href="inprogress-courses"><h5><i class='fa fa-book'></i> Inprogress</h5>
    <p><?php echo $tprogress; ?></p></a>
  </div>
 <div class="column" >
    <a href="pending-courses"><h5><i class='fa fa-book'></i> Pending</h5>
    <p><?php echo $tpending; ?></p></a>
  </div>
  <div class="column" >
    <a href="completed-courses"><h5><i class='fa fa-graduation-cap'></i> Completed</h5>
    <p><?php echo $tcompleted; ?></p></a>
  </div>
  </div>
						<?php echo"
	  <center>
	  ...
	  <li><a href='my-courses'>All courses ($totalc)</a></li>
	  ...
	  <center><h5>Inprogress courses</h5></center></br>
		...
		$progess= number_format($progess);
			...
			}elseif($rowp['Status']== "Inprogress" AND $rowp['Step'] == 2){
