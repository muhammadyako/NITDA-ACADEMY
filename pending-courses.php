...
$LId=$_SESSION['LId'];
	 ...
	 $sql = " SELECT * FROM enrollment WHERE LId='$LId' AND Status='Pending' ORDER BY EId DESC ";
...
<!--			<section class="banner-area relative about-banner" id="home">	
			...
			<div class="whole-wrap">
				<div class="container">
					...
					<div class="section-top-border">
						<center><h4 class="mb-30">Pending Courses</h4></center>
						<?php echo"
	  <center>
	  <nav class='mnavbar'>	  
	  <ul class='mnav-links'>
	  ...
	  <li><a class='active' href='pending-courses'>Pending Approval ($tpending)</a></li> 
	  <li><a href='completed-courses'>Completed ($tcompleted)</a></li>	  
						...
						<?php	while($row = mysqli_fetch_array($result)){
							...
							$prog = " SELECT * FROM enrollment WHERE LId='$LId' AND Status='Pending' AND RefId='$row[RefId]' ORDER BY EId DESC ";	
