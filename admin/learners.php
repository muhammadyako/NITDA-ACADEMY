			...
			<div class="pd-ltr-20 xs-pd-20-10">
				<div class="min-height-200px">
					...
					<div class="card-box mb-30">
						<div class="pd-20">
							<h4 class="text-blue h4">Learners</h4>
							<p>
								<?php echo "$dl"; ?>
								<?php echo "$msg"; ?>
							</p>
									...
									<tr>
										...
										<td>
											<div class='dropdown'>
												...
												>
													<a class='dropdown-item' href='learner-profile.php?LId=$row[LId]&Email=$row[Email]'
														><i class='dw dw-eye'></i> View</a
													>
													<a class='dropdown-item' href='modify-user.php?UId=$row[LId]'
														><i class='dw dw-edit2'></i> Modify</a
													>
													<a class='dropdown-item' href='?ref=$ref&ru=$row[UserId]&s=$ref$row[LId]$ref'
