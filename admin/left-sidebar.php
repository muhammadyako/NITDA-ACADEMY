<div class="left-side-bar">
			<div class="brand-logo">
				<a href="index.php">
					<img src="vendors/images/logo.svg" alt="" class="dark-logo" />
					<img
			...
			<div class="menu-block customscroll">
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						<li class="dropdown">
							<a href="javascript:;" class="dropdown-toggle">
								<span class="micon bi bi-chat"></span
								><span class="mtext">Analytic</span>
							</a>
							<ul class="submenu">
								<li><a href="enrollment.php">Enrollment</a></li>
								<li><a href="learning-hour.php">Learning Hour</a></li>
								<li><a href="learning-progress.php">Learning Progress</a></li>
								<li><a href="learner-statistics.php">Learner Statistics</a></li>
								<!--<li><a href="courses-analysis.php">Course Analysis</a></li>	-->							
							</ul>
						</li>
						<li class="dropdown">
							<a href="javascript:;" class="dropdown-toggle">
						...
						<li class="dropdown">
							...
							<ul class="submenu">
								<li><a href="enrollment-request.php">Enrollment Request</a></li>								
							</ul>
						</li>
						<?php
				   ...
				   echo '
						...
						<li class="dropdown">
							<a href="javascript:;" class="dropdown-toggle">
								<span class="micon bi bi-safe"></span
						...
						<li class="dropdown">
							<a href="javascript:;" class="dropdown-toggle">
								<span class="micon bi bi-people"></span
								><span class="mtext">Learners</span>
							</a>
							<ul class="submenu">
							<!--	<li><a href="create-user.php">Add User</a></li> -->
								<li><a href="learners.php">View Learners</a></li>
								<li><a href="allow-quiz.php">Allow Quiz</a></li>
							</ul>
						</li>						
						<li class="dropdown">
							<a href="javascript:;" class="dropdown-toggle">
							...
							<ul class="submenu">
								...
								<li><a href="course-category.php">View Courses</a></li>
								<li><a href="add-course-content.php">Add Course Outline</a></li>
								<li><a href="outline.php">Courses Outline</a></li>
							</ul>
						</li>
						<li class="dropdown">
							<a href="javascript:;" class="dropdown-toggle">
								<span class="micon bi bi-book"></span
								><span class="mtext">Course Materials</span>
							</a>
							<ul class="submenu">
								<li><a href="upload-pdf.php">Upload PDF</a></li>
								<li><a href="upload-video.php">Upload Video</a></li>
								<!--<li><a href="pdfs.php">PDFs</a></li>								
								<li><a href="video-clips.php">Video-clips</a></li>-->
							</ul>
						</li>
						<li class="dropdown">
							<a href="javascript:;" class="dropdown-toggle">
							...
							<ul class="submenu">
								...
								<li><a href="displayed-feedback.php">Displayed Feedback</a></li>
							</ul>
						</li>
						<li>
