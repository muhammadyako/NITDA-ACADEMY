...
$CourseCode =  strtoupper(mysqli_real_escape_string  ($link,$_GET['CourseCode']));	
 ...
 $sql = " SELECT * FROM ebook WHERE EbookId='$EId' AND CourseCode='$CourseCode'";
...
$ebookmime=finfo_file($finfo,$_FILES['Ebook']['tmp_name']);
		...
		if ($ebookmime !=='application/pdf' AND !empty($_FILES['Ebook']['tmp_name'])){
...
if($errors == 0){
$upda="UPDATE ebook SET EbookTitle='$EbookTitle', CourseCode='$CourseCode' WHERE EbookId='$EId'";
...
$msg= "<center><msg>Course material Updated Successfully!</msg></center>";
}
}
						...
						<form method="post" action="" enctype="multipart/form-data">
							<div class='row'>
								<div class='col-md-6'>
									...
									<input class='form-control' type='hidden' name='EId' value="<?php echo $EId; ?>">
