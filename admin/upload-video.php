...
if($errors == 0){
$sqlb = " INSERT INTO videos (Ref, Source, Url, CourseCode, VideoTitle, FileName) VALUES ('$Ref','$Source','$Url','$CourseCode', '$VideoTitle','$Clipname')";	
			...
			<div class="pd-ltr-20 xs-pd-20-10">
				<div class="min-height-200px">
					...
					<div class="pd-20 card-box mb-30">
						<div class="clearfix">
							<div class="pull-left">
								<h4 class="text-blue h4">Upload Video Clips</h4>
