		...
		<div class="main-container">
			<div class="pd-ltr-20 xs-pd-20-10">
				<div class="min-height-200px">
					...
					<center><h4 class="h4 text-blue mb-30">Categories</h4></center>
					...
					echo"
						<div class='col-sm-12 col-md-4 mb-30'>
							<div class='card card-box'>
								<div class='card-body'>
									<h5 class='card-title'>$row[CategoryName]</h5>
									<p class='card-text'>
										$row[Description]
									</p>
									<a href='courses.php?CategoryId=$CategoryId&RefId=$RefId&CategoryName=$CategoryName' class='btn btn-secondary btn-sm'>Open</a>
								</div>
							</div>
						</div>";
										  }
