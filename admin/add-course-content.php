...
$Date="$da[mday] $da[month] $da[year]";
		 ...
		 $sql = " SELECT * FROM outline WHERE CourseCode='$CourseCode' AND Outline='$Outline'";	
		...
		if ($rownum >0){
		$ExistOutline = "<spanb>Outline <b> $CourseCode: $Outline </b>already exist</spanb>";
		$errors = 1;
		}
...
if($errors == 0){
$sqlb = " INSERT INTO outline (RefId,CourseCode, Outline, Content) VALUES ('$RefId','$CourseCode', '$Outline','$Content')";	
if(mysqli_query ($link, $sqlb)){
$upd="UPDATE course SET LastUpdated='$Date' WHERE CourseCode='$CourseCode'";	
	$exc=mysqli_query ($link, $upd);
$msg= "<center><msg>Executed Successfully!</msg></center>";
}else{
$msg= "<center><spanb>Not Executed!</spanb></center>";	
}
}
}
			...
			<div class="pd-ltr-20 xs-pd-20-10">
				<div class="min-height-200px">
					...
					<div class="html-editor pd-20 card-box mb-30">
						<h4 class="h4 text-blue">Add course content/outline</h4>
						<p>Course outline and content</p>
						
						<center><?php echo "$msg $ExistOutline";?></center>
