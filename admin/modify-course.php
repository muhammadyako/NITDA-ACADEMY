...
$sqlm = " SELECT * FROM course WHERE RefId='$RefId' ";	
		 $resultm = mysqli_query($link, $sqlm);
		 $rowm = mysqli_fetch_array($resultm);
		 $CategoryName = $rowm['CategoryName'];
		 $CategoryId = $rowm['CategoryId'];
		 $CourseCode = $rowm['CourseCode'];
		 $CourseTitle = $rowm['CourseTitle'];
		 $TopCourse = $rowm['TopCourse'];
		 $Provider = $rowm['Provider'];
		 $Url = $rowm['Url'];
		 $Description = $rowm['Description'];
		 $Overview = $rowm['Overview'];
		 $Eligibility = $rowm['Eligibility'];
		 $Requirement = $rowm['Requirement'];
		 $Duration = $rowm['Duration'];
		 $Status = $rowm['Status'];
		 $RefId = $rowm['RefId'];
...
$CourseMaterialmime=finfo_file($finfo,$_FILES['CourseMaterial']['tmp_name']);
		...
		//$errors = 1;
		//}
		if ($CourseMaterialmime !=='application/pdf' AND $CourseMaterialmime !='' ){
...
$upd="UPDATE course SET CategoryId='$CategoryId',CategoryName='$CategoryName',CourseCode='$CourseCode',CourseTitle='$CourseTitle',Provider='$Provider',Url='$Url',Eligibility='$Eligibility',Description='$Description',
Overview='$Overview',LastUpdated='$Date',Duration='$Duration',Status='$Status',TopCourse='$TopCourse' WHERE RefId='$RefId'";			
				...
				<div class="min-height-200px">
					...
					<div class="pd-20 card-box mb-30">
						<div class="clearfix">
							...
							<h4 class="text-blue h4">Modify Course</h4>							
