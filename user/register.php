...
header("location: verify?msg=$msg&Email=$Email&Code=$VCode");
}else{
				...
				<center><?php echo "$msg";  ?></center>
					...
					<div class="form-row">
						...
						<div class="form-wrapper">
							...
							<input type="password" name="Rpassword" value="<?php echo $Rpassword; ?>" class="form-control" placeholder="Repeat Password">
