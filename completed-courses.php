...
$LId=$_SESSION['LId'];
	 ...
	 $sql = " SELECT * FROM enrollment WHERE LId='$LId' AND Status='Completed' ORDER BY EId DESC ";
...
$record="<center><spanb>No record found!</spanb></center>";	
}
}
...
<!--			<section class="banner-area relative about-banner" id="home">	
			...
			<div class="whole-wrap">
				<div class="container">
					...
					<div class="section-top-border">
						<center><h4 class="mb-30">Completed Courses</h4></center>
						<?php echo"
	  <center>
	  <nav class='mnavbar'>	  
	  <ul class='mnav-links'>
	  ...
	  <li><a class='active' href='completed-courses'>Completed ($tcompleted)</a></li>	  
	  </div>
	</ul>	  
	  </nav>
	  </center></p>"; ?>
						...
						<?php	while($row = mysqli_fetch_array($result)){
							...
							$prog = " SELECT * FROM enrollment WHERE LId='$LId' AND Status='Completed' AND RefId='$row[RefId]' ORDER BY EId DESC ";	
