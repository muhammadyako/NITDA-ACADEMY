...
<!--			<section class="banner-area relative about-banner" id="home">	
    ...
    <table class="tablemanager">
    	<thead>
    		<tr>				
				...
				<th>Status</th>				
				<th class="disableFilterBy"><spanb>Action</spanb></th>
			</tr>
    	</thead>
		<tbody>
	...
	<?php	
			while($row = mysqli_fetch_array($result)){
				...
				echo"	<tr>				
				<td class='prova'>$row[CourseTitle]</td>
				<td class='prova'>$row[SDate]</td>
				<td class='prova'>$row[Status]</td>				
				<td class='prova'><a href='course-view.php?CId=$row[CourseCode]&RefId=$row[RefId]'><button class='genric-btn primary small'>Open</button></a></td>
			</tr>						
			";
			}else{
				echo"	<tr>				
				...
				echo"<td class='prova'><b>$row[Status]</b></td>";
				}else{
				echo"<td class='prova'><a href='$row[Url]'><button class='genric-btn primary small'>Open</button></a></td>
			</tr>						
			";
				}
			}
