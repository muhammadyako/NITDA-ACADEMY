				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-between">
						<div class="banner-content col-lg-9 col-md-12">
							...
							<p>The National Information Technology Development Agency (NITDA), provides a platform for Nigerians to build digital skills and capacity to make them more employable, access the benefit of the Digital Economy, and to have the requisite skills to start enterprises.</p>
							<!--<p class="pt-10 pb-10">
