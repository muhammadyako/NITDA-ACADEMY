	<?php session_start();//require_once 'connectors/session.php';?>
...
//$search =  htmlspecialchars(mysqli_real_escape_string  ($link,$_GET['search']));
$search =  htmlspecialchars(ucwords(mysqli_real_escape_string  ($link,$_GET['search'])));


		
		$sqlc = " SELECT * FROM course WHERE CourseTitle LIKE '%$search%' OR CategoryName LIKE '%$search%'";
	
		$resultc = mysqli_query($link, $sqlc);
		//$rowsc = mysqli_fetch_array($resultc);
		if(mysqli_num_rows($resultc)<1){
			$t = mysqli_num_rows($resultc);
...
<!--			<section class="banner-area relative about-banner" id="home">	
			...
			<!-- End banner Area -->	</br></br></br></br></br></br></br></br></br>
			...
			<div class="row d-flex justify-content-center">
						<div class="menu-content pb-70 col-lg-8">
							<div class="title text-center">								
								...
								<input class="form-control" type="text" width="500" maxlength="200" placeholder="Search....." name="search" value="<?php echo $search;?>" />
	</p>
...
<!-- Start popular-courses Area --> 
			...
			$require="This course requires approval to enroll";	
						...
						echo"<div class='single-popular-carusel col-lg-3 col-md-6'>
							...
							<div class='details'>
								<a href='course-details.php?Ci=$rowc[CourseId]&CourseId=$rowc[CourseId]&RefId=$rowc[RefId]'>
									<h4>
										$rowc[CourseTitle]
									</h4>
								</a>
